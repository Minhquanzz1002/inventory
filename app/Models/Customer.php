...
class Customer extends Model
{
    ...
    public function validate(array $data, bool $isUpdate = false) : string
    {
        $validators = [
            ...
            'name' => v::notEmpty()->setName('name')->setTemplate('Tên không hợp lệ. Tên phải viết hoa chữ cái đầu tiên của mỗi từ và chỉ chứa chữ cái.'),
            ...
            'status' => v::notEmpty()->in(['ACTIVE', 'TEMPORARILY_SUSPENDED'])->setName('status')->setTemplate('Trạng thái không được rỗng và chỉ được phép là ACTIVE hoặc ENABLE.'),
        ];
